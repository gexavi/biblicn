...
function updateSecondhandLinks(book) {
  ...
  // renvoyer n'importe quelle édition du livre) mais certains sites ne
  // l'indexent pas en texte visible : on le met en priorité via un OR, avec
  // titre+auteur en repli dans la même recherche plutôt qu'un choix strict
  // qui peut ne renvoyer aucun résultat.
  ...
  $('#linkChasseAuxLivres').href = `https://www.google.com/search?q=site%3Achasse-aux-livres.fr+${query}`;
  wrap.hidden = false;
}
